...
_Generated by `/teams:create`. Edit freely below the imported block; re-running `/teams:create` preserves your edits._

Severity bar: must-fix blocks · should-fix {{SEVERITY_BAR}}   <!-- {{SEVERITY_BAR}} = "warns" | "blocks" -->

# imported from CLAUDE.md (auto-regenerated by /teams:create — edit CLAUDE.md, not this block)

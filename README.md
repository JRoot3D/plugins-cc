...
- **`teams`** — multi-agent team orchestration. Skills: `teams:create`, `teams:flow`. Requires the `flow` and `serena` plugins and an experimental Claude Code setting (see [Teams](#teams)).
...
```
/teams:create   (or: "set up teams flow", "configure teams:flow for this project")
